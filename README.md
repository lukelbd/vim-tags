...
| `<Leader><CR>` | Jump to the window and line number corresponding to the tag under the cursor. If the no tag is found a warning is printed. The map can be changed with `g:tags_jump_map`. |
